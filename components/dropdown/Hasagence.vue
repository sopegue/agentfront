      ...
      <div class="w130px">
        <client-only>
          <div
            ...
            class="flex align-center button border rounded clickable w130px select-none space-x-1"
            @click="
              {
                focused = !focused
              }
...
export default {
  data() {
    return {
      focused: false,
      searching: '',
      ctry: "Non, je ne dispose pas d'agence sur Ofaloo",
      lan: [
        "Non, je ne dispose pas d'agence sur Ofaloo",
        "Oui, j'ai déjà une agence sur Ofaloo",
      ],
    }
  },
  computed: {
