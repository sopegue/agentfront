<template>
  <div
    class="bg-white border h-8 flex align-center rounded relative"
    :class="{
  ...
  >
    ...
    <div class="relative w-min-48 w-max-74 flex align-center mr-10">
      <div
        v-show="inputfocused"
        class="rounded-bl border rounded-br bg-white h-10 shadow-xs w-full absolute z-12 top-0 mt-6.3 -ml-0.8"
      ></div>
      <input
        id="byuyc"
        autocomplete="none"
    ...
    <button
      class="h-full btn-008489 absolute h-8 right-0 px-3 rounded-tr rounded-br text-white size-13 font-semibold"
